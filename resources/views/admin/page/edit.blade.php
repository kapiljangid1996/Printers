	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="category">Edit Page</li>
			</ol>
		</nav>
	</div>
</div>
...
<div class="row">
	<div class="col-md-12">
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<form action="{{ route('page.update',$pages->id) }}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
					@method('PUT')
					<div class="form-group row">
						<label for="title" class="col-sm-2 col-form-label">Name</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="name" name="title" value="{{$pages->title}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="slug" name="slug" value="{{$pages->slug}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="long_description" required>{{$pages->long_description}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="short_description" rows="3" required>{{$pages->short_description}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<input type="hidden" class="form-control" name="old_image" value="{{$pages->image}}">
							<br>
								...
								<div class="col-md-3">
			                      	<div class="card shadow text-center mb-4">
				                        <div class="card-body file">
				                          	<div class="my-4">
				                            	<img src="/Uploads/Page/{{$pages->image}}"  width="80px">
				                          	</div>
				                        </div>
			                      	</div>
			                    </div>	
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="meta_name" value="{{$pages->meta_name}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="meta_keyword" rows="3" required>{{$pages->meta_keyword}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="meta_description" rows="3" required>{{$pages->meta_description}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<input type="checkbox" name="publish" value="1" style="margin-top: 7px" @if(old('publish', $pages->publish)) checked @endif>
						</div>
					</div>
