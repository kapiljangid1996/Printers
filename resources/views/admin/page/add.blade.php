	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="category">Add Page</li>
			</ol>
		</nav>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="card shadow mb-4">
			<div class="card-header">
				<strong class="card-title">Add Page</strong>
			</div>
			<div class="card-body">
				<form action="{{ route('page.store') }}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
					...
					<div class="form-group row">
						<label for="slug" class="col-sm-2 col-form-label">Publish</label>
						<div class="col-sm-10">
							<input type="hidden" name="publish" value="0">
							<input type="checkbox" name="publish" checked="" value="1" style="margin-top: 7px">
						</div>
					</div>
