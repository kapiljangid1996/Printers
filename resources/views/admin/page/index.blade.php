	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="product">Pages</li>
			</ol>
		</nav>
	</div>
</div>
		...
		<div class="card shadow">
			...
			<div class="card-body">
				<div class="toolbar">
					<div class="row">
						<div class="col-sm-6">
							<a href="{{route('page.create')}}" class="btn btn-primary btn-round">Add</a>
						</div>
						<div class="col-sm-6">
				...
				<table class="table table-borderless table-hover">
					...
					<tbody id="myTable">
						...
						<tr>
							...
							<td>{{ $page->title }}</td>
							<td>{{ $page->slug }}</td>
							<td><img src="/Uploads/page/{{ $page->image }}" width="75px"></td>
							<td>
								@if($page->publish == 1)
                                  	Yes
                              	@else
