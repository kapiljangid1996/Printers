	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="{{url('/admin/setting')}}">Site</a></li>
...
<div class="row">
	<div class="col-md-12">
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<form action="{{url('/admin/setting/'.$settings[0]->id)}}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
					<div class="form-group row">
						<label for="title" class="col-sm-2 col-form-label">Name</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="title" value="{{$settings[0]->title}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="email" class="form-control" name="email1" value="{{$settings[0]->email1}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="email" class="form-control" name="email2" value="{{$settings[0]->email2}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="contact1" value="{{$settings[0]->contact1}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="contact2" value="{{$settings[0]->contact2}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="address1" required>{{$settings[0]->address1}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="address2" required>{{$settings[0]->address2}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<input type="hidden" class="form-control" name="old_logo" value="{{$settings[0]->logo}}">
							<br>
								...
								<div class="col-md-3">
			                      	<div class="card shadow text-center mb-4">
				                        <div class="card-body file">
				                          	<div class="my-4">
				                            	<img src="/Uploads/Site/{{$settings[0]->logo}}"  width="80px">
				                          	</div>
				                        </div>
			                      	</div>
			                    </div>	
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="google" value="{{$settings[0]->google}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="facebook" value="{{$settings[0]->facebook}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="linkedin" value="{{$settings[0]->linkedin}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="twitter" value="{{$settings[0]->twitter}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="footer" required>{{$settings[0]->footer}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="meta_name" value="{{$settings[0]->meta_name}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="meta_keyword" required>{{$settings[0]->meta_keyword}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="meta_description" required>{{$settings[0]->meta_description}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="google_analyst" required>{{$settings[0]->google_analyst}}</textarea>
